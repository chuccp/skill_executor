...
export const COMMAND_TIMEOUT_MS = 60000000; // 命令执行默认超时（1分钟）

// ==================== Web 请求配置 ====================

export const WEB_SEARCH_TIMEOUT_MS = 10000; // 网络搜索超时
export const WEB_SEARCH_MAX_RESULTS = 100; // 网络搜索最大结果数
...
export const HTTP_MAX_RETRIES = 3; // HTTP 请求最大重试次数

// ==================== Agent 配置 ====================

export const AGENT_COMPLETION_TIMEOUT_MS = 30000000; // Agent 完成等待超时（5分钟）